...
async def recognize_with_gpt(file: UploadFile = File(...)):
    try:
        ...
        gpt_response = openai_client.chat.completions.create( model="gpt-5-mini", messages=[ {"role": "system", "content": "Ти досвідчений парсер накладних."}, {"role": "user", "content": prompt} ], temperature=0.1, max_completion_tokens=2000 )
