...
async def recognize_with_gpt(file: UploadFile = File(...)):
    try:
        ...
        gpt_response = openai_client.chat.completions.create( model="gpt-4o", messages=[ {"role": "system", "content": "Ти досвідчений парсер накладних."}, {"role": "user", "content": prompt} ], temperature=0.1, max_tokens=2000 )
